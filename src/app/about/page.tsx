    ...
    <div className="mx-auto max-w-[760px] px-6 py-16 md:py-24 animate-fade-up prose-page">
      ...
      <div className="mt-8">
        ...
        <section>
          ...
          <p>
            We wanted to offer a better solution—a focused platform that generates high-quality headcanons instantly. We built Headcanon Space so anyone could press a button and immediately get randomized, specific prompts tailored to their storytelling needs.
          </p>
        </section>
